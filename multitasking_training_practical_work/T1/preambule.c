...
void *produce(void *params) // Identifiez dans le programe le point d'entré du thread.
{
...
int main()
{
    ...
    pthread_create(&thread_1, NULL, produce, NULL); // create 的时候启动线程，produce 为启动的线程
